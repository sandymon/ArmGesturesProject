...
def run_camera():
    ...
    while time.time() - start_time < timer_durantion:
        print(start_time)
        ...
        for hand in Hands:
            lmList = hand["lmList"]
            if square_x <= lmList[8][0] <= square_x + square_size and square_y <= lmList[8][
                1] <= square_y + square_size:
